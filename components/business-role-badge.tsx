...
export function BusinessRoleBadge({
  ...
  const className =
    tone === "inverse"
      ? isPartner
        ? "inline-flex items-center rounded-full border border-[#a785f0]/45 bg-[#7c4ad9]/22 px-2 py-[0.15rem] text-[10px] font-medium tracking-[0.14em] uppercase text-[#f3ecff]"
      ...
      : isPartner
        ? "inline-flex items-center rounded-full border border-[#ceb5ff] bg-[#f2eaff] px-2.5 py-0.5 text-[13px] font-medium text-[#6f42c1]"
